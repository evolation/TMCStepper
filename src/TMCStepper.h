...
#include "source/esp32-hal-gpio.h"
...
#define INIT2160_REGISTER(REG) TMC2160_n::REG##_t REG##_register = TMC2130_n::REG##_t
#define INIT5130_REGISTER(REG) TMC5130_n::REG##_t REG##_register = TMC2130_n::REG##_t
#define INIT5160_REGISTER(REG) TMC5160_n::REG##_t REG##_register = TMC2130_n::REG##_t
#define INIT2660_REGISTER(REG) TMC2660_n::REG##_t REG##_register = TMC2130_n::REG##_t
#define INIT2208_REGISTER(REG) TMC2208_n::REG##_t REG##_register = TMC2130_n::REG##_t
...
#define TMCSTEPPER_VERSION 0x000300 // v0.3.0
